...
id: llm-service
title: LLM Service
description: "Language model service providing knowledge capture and note synthesis capabilities"
tags: [Production]
connections: []
metadata:
  serviceType: llm
...
Provides access to a large language model for knowledge capture and note synthesis. Used by all skills in this skrpt.
